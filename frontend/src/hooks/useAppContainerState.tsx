...
export function useAppContainerState() {
  ...
  return {
    ...
    globalUIProps: {
      ...
      scheduleAction: baseState.scheduleAction,
      scheduleActionLabel: getActionLabel(baseState.scheduleAction),
      scheduleTarget: baseState.scheduleTarget,
      onScheduleActionChange: baseState.setScheduleAction,
      onScheduleTargetChange: baseState.setScheduleTarget,
      availableActions: getAvailableActionsForDevice(deviceHooks.selectedDevice),
